...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 205 26" }, props),
        React__default['default'].createElement("image", { width: "205", height: "26", href: isDark ? '/images/net/LogoTextNewDark.png' : '/images/net/LogoTextNewWhite.png' })));
};
...
var Icon$11 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React__default['default'].createElement("path", { d: "M18.07,7.926c-0.083-0.003-0.164-0.008-0.246-0.007h0.327C18.122,7.919,18.095,7.926,18.07,7.926z M28.021,11.903\n\t\tc0.062,0,0.118,0.004,0.178,0.006c0.021,0,0.039-0.006,0.06-0.006H28.021z M13.423,15.885c0.012-0.002,0.021-0.015,0.032-0.018\n\t\tc0.728,2.637,2.616,4.611,4.532,4.653c1.748-0.08,3.89-2.02,4.604-4.642c0.329,0.02,0.655-0.368,0.749-0.907\n\t\tc0.098-0.562-0.104-1.063-0.441-1.122c-0.022-0.004-0.043,0.01-0.064,0.01c-0.1-4.339-2.16-5.869-4.757-5.935\n\t\tc-2.676,0.011-5.074,1.873-4.922,5.936c-0.025,0-0.049-0.015-0.075-0.011c-0.339,0.059-0.538,0.56-0.442,1.122\n\t\tC12.729,15.533,13.082,15.942,13.423,15.885z M17.949,20.522h0.074c-0.014,0-0.028-0.002-0.042-0.002\n\t\tC17.97,20.521,17.961,20.522,17.949,20.522z M24.843,17.652c0.009-0.003,0.015-0.011,0.022-0.013\n\t\tc0.526,1.903,1.888,3.326,3.27,3.355c1.262-0.058,2.807-1.457,3.322-3.348c0.236,0.013,0.474-0.265,0.539-0.654\n\t\tc0.068-0.406-0.073-0.769-0.319-0.81c-0.015-0.003-0.03,0.008-0.045,0.008c-0.071-3.131-1.56-4.235-3.433-4.282\n\t\tc-1.93,0.008-3.66,1.352-3.551,4.282c-0.02,0-0.035-0.012-0.054-0.008c-0.244,0.041-0.39,0.404-0.319,0.81\n\t\tC24.343,17.397,24.597,17.692,24.843,17.652z M28.167,20.996c-0.013,0-0.021-0.002-0.031-0.002c-0.006,0-0.017,0.001-0.021,0.002\n\t\tH28.167z M21.593,21.272L19.16,26.03l-0.383-3.095l0.601-0.492h-1.455h-1.33l0.601,0.492L16.81,26.03l-2.43-4.758\n\t\tc-4.225,0.569-7.258,2.38-7.258,6.782h21.73C28.85,23.652,25.816,21.842,21.593,21.272z M7.722,11.903\n\t\tc0.061,0,0.119,0.004,0.177,0.006c0.02,0,0.04-0.006,0.059-0.006H7.722z M8.407,22.736l0.433-0.354H7.791H6.832l0.433,0.354\n\t\tl-0.277,2.232l-1.751-3.432C2.188,21.948,0,23.255,0,26.431h6.985c0.231-1.184,0.734-2.174,1.513-2.98L8.407,22.736z\n\t\t M30.736,21.537l-1.752,3.433l-0.276-2.232l0.433-0.354h-1.05h-0.959l0.435,0.354l-0.088,0.713c0.775,0.808,1.278,1.798,1.512,2.98\n\t\th6.983C35.973,23.255,33.785,21.948,30.736,21.537z M7.867,20.996c-0.011,0-0.02-0.002-0.03-0.002\n\t\tc-0.007,0-0.016,0.001-0.023,0.002H7.867z M4.545,17.652c0.009-0.003,0.015-0.011,0.024-0.013c0.525,1.903,1.886,3.326,3.269,3.355\n\t\tc1.26-0.058,2.806-1.457,3.321-3.348c0.236,0.013,0.474-0.265,0.54-0.654c0.069-0.406-0.075-0.769-0.32-0.81\n\t\tc-0.016-0.003-0.031,0.008-0.046,0.008c-0.071-3.131-1.559-4.235-3.432-4.282c-1.93,0.008-3.66,1.352-3.551,4.282\n\t\tc-0.019,0-0.035-0.012-0.053-0.008c-0.245,0.041-0.389,0.404-0.32,0.81C4.046,17.397,4.299,17.692,4.545,17.652z" })));
};

var Icon$12 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "-60 -30 600 600" }, props),
        React__default['default'].createElement("g", { transform: "translate(0.000000,512.000000) scale(0.100000,-0.100000)", stroke: "none" },
            React__default['default'].createElement("path", { d: "M2360 5109 c-106 -12 -259 -46 -365 -80 -127 -42 -353 -157 -465\n-236 -108 -78 -276 -235 -360 -338 -236 -288 -380 -660 -396 -1020 l-6 -130\n89 -101 c48 -56 329 -368 623 -693 294 -325 536 -595 537 -599 2 -4 -17 -20\n-42 -36 -121 -76 -261 -238 -338 -391 -200 -400 -111 -896 218 -1203 514 -481\n1338 -322 1637 315 154 328 122 709 -85 1018 -49 74 -195 220 -259 260 -27 17\n-48 32 -48 35 0 6 -17 -14 615 686 254 280 500 554 548 608 l87 100 0 58 c0\n86 -18 239 -42 348 -145 677 -691 1223 -1368 1368 -185 40 -399 51 -580 31z\nm-782 -1605 c96 -19 241 -89 305 -146 l48 -43 194 -640 193 -640 -74 -24 -73\n-25 -40 45 c-21 24 -293 325 -605 669 l-565 625 42 38 c23 21 83 58 132 82\n145 72 288 91 443 59z m1120 0 c89 -18 239 -87 294 -136 l38 -33 -193 -635\n-192 -635 -85 -3 -85 -2 -192 637 -192 638 37 33 c52 46 204 118 287 136 93\n19 189 19 283 0z m1141 -4 c96 -23 217 -83 278 -137 l43 -38 -601 -665 c-331\n-366 -607 -666 -613 -668 -6 -1 -41 8 -77 20 l-66 23 193 640 193 640 48 43\nc62 55 209 127 298 146 100 21 206 19 304 -4z m-1074 -1771 c246 -76 419 -251\n496 -499 34 -108 34 -292 0 -400 -77 -248 -253 -424 -501 -501 -62 -20 -97\n-24 -200 -24 -103 0 -138 4 -200 24 -250 77 -423 250 -501 501 -34 107 -34\n292 0 400 85 275 301 470 579 520 78 15 248 4 327 -21z" }),
            React__default['default'].createElement("path", { d: "M2433 1585 c-94 -21 -198 -79 -275 -156 -222 -220 -222 -577 1 -800\n276 -276 737 -200 910 151 210 428 -168 907 -636 805z m82 -110 c16 -15 25\n-36 25 -55 0 -23 4 -30 20 -30 16 0 20 7 20 30 0 19 9 40 25 55 53 53 135 15\n135 -63 0 -35 5 -42 39 -65 50 -33 91 -113 91 -177 0 -29 -9 -64 -24 -93 l-23\n-47 23 -47 c15 -29 24 -64 24 -93 0 -64 -41 -144 -91 -177 -34 -23 -39 -30\n-39 -65 0 -78 -82 -116 -135 -63 -16 15 -25 36 -25 55 0 23 -4 30 -20 30 -16\n0 -20 -7 -20 -30 0 -41 -39 -80 -80 -80 -41 0 -80 39 -80 80 0 28 -2 30 -40\n30 -80 0 -119 82 -65 135 13 14 33 25 45 25 19 0 20 5 20 200 0 195 -1 200\n-20 200 -12 0 -32 11 -45 25 -54 53 -15 135 65 135 38 0 40 2 40 30 0 41 39\n80 80 80 19 0 40 -9 55 -25z" }),
            React__default['default'].createElement("path", { d: "M2500 1170 l0 -60 85 0 c72 0 88 3 105 20 11 11 20 29 20 40 0 11 -9\n29 -20 40 -17 17 -33 20 -105 20 l-85 0 0 -60z" }),
            React__default['default'].createElement("path", { d: "M2500 890 l0 -60 85 0 c72 0 88 3 105 20 11 11 20 29 20 40 0 11 -9\n29 -20 40 -17 17 -33 20 -105 20 l-85 0 0 -60z" }))));
};
...
var UserBlock = function (_a) {
    ...
    return (React__default['default'].createElement(Container$2, null, account ? (React__default['default'].createElement(Button, { fullWidth: true, size: "md", onClick: function () {
            onPresentAccountModal();
        } }, accountEllipsis)) : (React__default['default'].createElement(Button, { fullWidth: true, size: "md", onClick: function () {
...
var PanelBody = function (_a) {
    ...
    return (React__default['default'].createElement(Container$4, null, links.map(function (entry) {
        var Icon = Icons[entry.icon];
        var iconElement = React__default['default'].createElement(Icon, { width: "32px", mr: "8px" });
...
var PanelFooter = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav; _a.toggleTheme; _a.isDark; _a.cakePriceUsd; var currentLang = _a.currentLang, langs = _a.langs, setLang = _a.setLang; _a.priceLink;
    if (!isPushed) {
...
var Panel = function (props) {
    var isPushed = props.isPushed, showMenu = props.showMenu, account = props.account, login = props.login, logout = props.logout;
...
var PriceLink = styled__default['default'].a(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"])));
var SettingsEntry = styled__default['default'].div(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  margin-right: 16px;\n"], ["\n  display: flex;\n  align-items: center;\n  margin-right: 16px;\n"])));
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            ...
            React__default['default'].createElement(Flex, null,
                ...
                React__default['default'].createElement(Button, { variant: "secondary", onClick: function () { return toggleTheme(!isDark); } },
        ...
        React__default['default'].createElement(BodyWrapper, null,
            React__default['default'].createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links, priceLink: priceLink, account: account, login: login, logout: logout }),
            React__default['default'].createElement(Inner, { isPushed: isPushed, showMenu: showMenu }, children),
            React__default['default'].createElement(MobileOnlyOverlay, { show: isPushed, onClick: function () { return setIsPushed(false); }, role: "presentation" }))));
};
var templateObject_1$H, templateObject_2$e, templateObject_3$8, templateObject_4$3, templateObject_5$1, templateObject_6, templateObject_7;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#F0B90B", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#21201e", textDisabled: "#BDC2C4", textSubtle: "#21201e", borderColor: "#E9EAEB", card: "#ffffff", gradients: {
...
var light$1 = (_a$2 = {},
    ...
    _a$2[SECONDARY] = {
        ...
        borderColorHover: "2px solid " + lightColors.primaryBright,
        boxShadow: "none",
